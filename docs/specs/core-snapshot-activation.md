...
Schema version `8` and registry version `18` govern three Core authority tables:
...
19. A schema version other than `8` or registry version other than `18` MUST fail
