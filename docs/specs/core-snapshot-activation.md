...
Schema version `7` and registry version `16` govern three Core authority tables:
...
19. A schema version other than `7` or registry version other than `16` MUST fail
