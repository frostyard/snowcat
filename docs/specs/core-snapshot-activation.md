...
Schema version `5` and registry version `12` govern three Core authority tables:
...
19. A schema version other than `5` or registry version other than `12` MUST fail
