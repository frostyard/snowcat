...
elapsed source freshness from the stricter new-admission gate. Its durable
  ...
  Registry version 15 fixes source-native App-hook, pull-request, check-run,
  ...
  Evidence-citing content-gap closure, installation binding, scheduling and
...
| GitHub observation | Complete the accepted webhook-plus-polling boundary on the registered v15 vocabulary and ADR-0058 operating bounds; exact-body HMAC verification, allowlisted same-repository normalization, an unmounted bounded router, durable acceptance, typed pull-request-delivery checkpoint/gap/repair persistence, bounded App delivery-list/detail acquisition, and receipt-free API repair persistence are implemented, while production listener lifecycle, evidence-citing content-gap closure, scheduled leases, remaining records and commands, installation and actor mapping, CI/review/merge and artifact predicates, forks, and external decision signals remain |
...
- What exact registered record schemas, command outputs, pagination proof, and
  ...
  model and ADR-0058 operating bounds on the v15 subject and revision
